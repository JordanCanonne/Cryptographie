...
public class VigenereMenu implements Menu {
	...
	public void menu() {
		...
		System.out.println("******************Menu du protocole de Vigenere******************\n\n");
		...
		Vigenere cryptologist = new Vigenere();
		String clear;
		String key;
		String chiffred;
		...
		switch (choice) {
		case 1:
			System.out.println("******************Chiffrage de Vigenere******************\n\n");
			...
			System.out.println("\n\nTexte chiffré par le protocole de Vigenere : \n");
		...
		case 2:
			System.out.println("******************Dechiffrage de Vigenerer******************\n\n");
			...
			System.out.println("\n\nTexte déchiffré par le protocole de Vigenere : \n");
		...
		case 3:
			System.out.println("******************Decryptage de Vigenere******************\n\n");

			System.out.println("Saisissez un texte chiffré ([a-z,A-Z, é, è, à, -, _, !, .] : \n");
			
			chiffred = sc.next();

			System.out.println("\n\nDecryptage le plus probable trouvé par le protocole de Vigenere : \n");
